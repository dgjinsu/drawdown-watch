...
@Service
@Slf4j
public class YahooFinanceClient implements MarketDataPort {
    ...
    @Override
    public MarketDataPort.StockInfo fetchStockInfo(String symbol) {
        ...
        return new MarketDataPort.StockInfo(meta.shortName(), meta.exchangeName());
    }
