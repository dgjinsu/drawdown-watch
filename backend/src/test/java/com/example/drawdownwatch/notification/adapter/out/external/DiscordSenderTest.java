...
class DiscordSenderTest {
    ...
    private NotificationSetting buildDiscordSetting(String webhookUrl) {
    ...
    void send_204응답_정상완료() {
        ...
        NotificationSetting setting = buildDiscordSetting("https://discord.com/api/webhooks/test");

        // When / Then
        assertThatCode(() -> discordSender.send(setting, null, null, "테스트 메시지"))
    ...
    void send_4xx응답_RuntimeException발생() {
        ...
        // When / Then
        assertThatThrownBy(() -> discordSender.send(setting, null, null, "메시지"))
